...
bool genPcdFeature(pcl::PointCloud<LidarPointXYZIRT>::Ptr laserCloud,
  ...
  *pcd_corn = cornerPointsSharp;
  ...
  pcl::PointCloud<pcl::PointXYZI> temp_1,temp_2,temp_3,temp_4;
  {
    surfPointsFlat.swap(temp_1);
    surfPointsLessFlat.swap(temp_2);
    cornerPointsSharp.swap(temp_3);
    cornerPointsLessSharp.swap(temp_4);
