...
def drawCoordinateFrame( ax, rpy, t,scale=(1,1,1)):
        
    # define origin
    o = np.array([0,0,0])
    # define ox0y0z0 axes
    x0 = np.array([1*scale[0],0,0])
    y0 = np.array([0,1*scale[1],0])
    z0 = np.array([0,0,1*scale[2]])
    ...
    x = Arrow3D(   [o1[0], x1[0]],    [o1[1], x1[1]],     [o1[2], x1[2]] ,  mutation_scale=5, arrowstyle='-|>', color='r')
    y = Arrow3D(   [o1[0], y1[0]],    [o1[1], y1[1]],     [o1[2], y1[2]] ,  mutation_scale=5, arrowstyle='-|>', color='b')
    z = Arrow3D(   [o1[0], z1[0]],    [o1[1], z1[1]],     [o1[2], z1[2]] ,  mutation_scale=5, arrowstyle='-|>', color='g')
